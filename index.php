...
<head>
    ...
    <meta charset="utf-8" />
    <title>Acceso | Sistema Compra y Venta</title>
                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Acceder a Sistema Compra y Venta</p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <form action="" method="post" id="login_form">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select type="text" class="form-control form-select " name = "emp_id" id="emp_id" placeholder="Seleccionar">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select type="text" class="form-control form-select " name = "suc_id" id="suc_id" placeholder="Seleccionar">
